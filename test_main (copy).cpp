...
/*    test_regex_ECMAScript("[^a]");
    ...
    test_regex_ECMAScript("a*{a,3}");
    test_regex_ECMAScript("a*{ 1,3}");
...
//    test_regex_ECMAScript("a\\bc"); TODO negative test
//    test_regex_ECMAScript("[\\n-\\^]*"); // FIXME - produces core dump from time to time
...
//    test_regex_ECMAScript("((a$)|ab)c|a"); // FIXME - invalid (negative test)
    test_regex_ECMAScript("^$");

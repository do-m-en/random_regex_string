...
void repeat_range_regex_node_::generate(std::ostream& os, random_generator_base& random_gen, char& last_gen)
{
...
void repeat_range_regex_node_::regenerate(std::ostream& os, char& last_gen) const
{
  for(int i = 0; i < random_value_; ++i)
  {

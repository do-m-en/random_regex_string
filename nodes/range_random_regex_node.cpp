...
void range_random_regex_node_::generate(std::ostream& os, random_generator_base& random_gen, char& last_gen)
{
...
void range_random_regex_node_::regenerate(std::ostream& os, char& last_gen) const
{
  last_gen = generated_value_;
  os << generated_value_;
}
